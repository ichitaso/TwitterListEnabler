...
@interface TFNTwitterUser : NSObject <NSCoding, TFSPlistSerialization, TFSTwitterScribableItem, TFSModel, TFSTwitterCanonicalUser, TFNTwitterUserContext>
{
...
- (id)initTestUserWithUserID:(long long)arg1 username:(id)arg2 protectedUser:(_Bool)arg3;
