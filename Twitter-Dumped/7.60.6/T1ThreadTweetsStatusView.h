...
@interface T1ThreadTweetsStatusView : UIView <TFNComposableViewHost, T1TimelineStatusView>
{
...
@property(retain, nonatomic) T1StatusViewAccessibility *accessibility; // @synthesize accessibility=_accessibility;
