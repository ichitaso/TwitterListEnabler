...
@class NSString, T1AppSplitViewController;
@protocol T1TabBarIntegration;

@interface UIViewController (T1SettingsAccountInitializableWorkaroundForSwiftLeak) <T1DashContentItem, CNContactViewControllerDelegate, CNContactPickerDelegate, T1AddPhoneNumberDelegate, T1ListsOwnerDelegate, T1ComposerPresenting>
