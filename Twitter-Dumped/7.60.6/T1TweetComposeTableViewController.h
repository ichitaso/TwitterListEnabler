...
@property(nonatomic, getter=isSelfReply) _Bool selfReply; // @synthesize selfReply=_selfReply;
...
- (void)viewDidLoad;
- (id)initWithAccount:(id)arg1 scribeContext:(id)arg2 delegate:(id)arg3 compositions:(id)arg4;
