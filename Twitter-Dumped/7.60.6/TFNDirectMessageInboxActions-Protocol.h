...
- (void)markAsSeen;
- (void)loadMoreConversationsWithCursor:(TFNDirectMessageTimelineCursor *)arg1 includeQuality:(_Bool)arg2;
- (void)refresh:(long long)arg1 activeConversationID:(NSString *)arg2 filterLowQuality:(NSNumber *)arg3 includeQuality:(_Bool)arg4 completion:(void (^)(void))arg5;
@end
