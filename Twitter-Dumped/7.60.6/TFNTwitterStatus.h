...
@class NSArray, NSDate, NSDictionary, NSNumber, NSString, T1PlayerSessionProducer, TAVAnalyticsMediaIdentifier, TFNTwitterCanonicalStatus, TFNTwitterCardData, TFNTwitterConversationStructure, TFNTwitterDisplayTextModel, TFNTwitterDynamicVideoAd, TFNTwitterFeedbackInfo, TFNTwitterFeedbackModule, TFNTwitterGeotag, TFNTwitterMediaInfo, TFNTwitterPromotedContent, TFNTwitterRelevancePrompt, TFNTwitterStatusConversationContext, TFNTwitterSuggestsInfo, TFNTwitterTweetPrompt, TFNTwitterUser, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterEntityURL, TFSTwitterUserReference, TFSTwitterVideoMonetizationSettings, TFSURTRichText, UIColor, UIDragItem;
@protocol T1PlayerFactoryIdentifiable, T1StatusViewModel, TFNTwitterAVPlayerSessionSource, TFNTwitterCardDataSource, TFNTwitterStatusBanner, TFNTwitterStatusConversationTreeContext, TFNTwitterStatusSocialContext, TFNTwitterTimelineEntryContext;
...
+ (void)setIsMutableCopyOptimizationEnabled:(_Bool)arg1;
+ (_Bool)isMutableCopyOptimizationEnabled;
+ (void)initialize;
...
- (id)attributedTextModelForOptions:(unsigned long long)arg1 withFont:(id)arg2 boldFont:(id)arg3 lineHeight:(double)arg4 lineSpacing:(double)arg5 emptyLineMaxHeight:(double)arg6 darkBackground:(_Bool)arg7 defaultTextColor:(id)arg8 linkTextColor:(id)arg9 highlighted:(_Bool)arg10 truncationString:(id)arg11 cachingEnabled:(_Bool)arg12;
