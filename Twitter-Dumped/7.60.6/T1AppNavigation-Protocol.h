...
@protocol T1AutoplayFullscreenCoordinator, T1ImageTransitionDelegate><T1NewsCameraImageTransitionDataSource, T1StatusViewModel, TFNNavigationStack, TFSTwitterCanonicalUser;
...
- (void)showRuxWithCxt:(NSString *)arg1 refsrcTweet:(NSString *)arg2 statusID:(long long)arg3 panel:(long long)arg4 source:(long long)arg5 completion:(void (^)(void))arg6;
...
- (TFNViewController *)conversationViewControllerForViewModel:(id <T1StatusViewModel>)arg1 statusID:(long long)arg2 account:(TFNTwitterAccount *)arg3 statusNavigationContext:(T1ShowStatusNavigationContext *)arg4 scribeContext:(TFSTwitterScribeContext *)arg5;
- (void)showConversationViewControllerForViewModel:(id <T1StatusViewModel>)arg1 statusID:(long long)arg2 fromPanel:(long long)arg3 source:(long long)arg4 navigationContext:(T1AppNavigationContext *)arg5 statusNavigationContext:(T1ShowStatusNavigationContext *)arg6 completion:(void (^)(void))arg7;
- (void)showConversationViewControllerForViewModel:(id <T1StatusViewModel>)arg1 statusID:(long long)arg2 account:(TFNTwitterAccount *)arg3 statusNavigationContext:(T1ShowStatusNavigationContext *)arg4 scribeContext:(TFSTwitterScribeContext *)arg5 fromViewController:(UIViewController *)arg6 animated:(_Bool)arg7;
...
- (void)showProfileForCurrentAccountFromSource:(long long)arg1 completion:(void (^)(void))arg2;
