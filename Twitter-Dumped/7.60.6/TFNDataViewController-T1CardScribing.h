...
@class NSString, TAVUIAutoplayDisablingFilter, TAVUIAutoplayManager, UIView;
@protocol T1AutoplayableManager;

@interface TFNDataViewController (T1CardScribing) <T1MuteKeywordFormViewControllerDelegate, T1Autoplayable, TFNItemsDummyObjectDelegate>
...
@property(retain, nonatomic) TAVUIAutoplayDisablingFilter *carouselAutoplayDeactivationPolicy;
