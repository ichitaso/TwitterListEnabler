...
@property(readonly, nonatomic) TFNTwitterScribe *tfnScribe; // @synthesize tfnScribe=_tfnScribe;
...
- (void)_asyncNotifyUnretweetForOriginalStatus:(id)arg1 changePending:(_Bool)arg2;
- (void)_notifyRetweet:(id)arg1 originalStatus:(id)arg2 changePending:(_Bool)arg3 retweetID:(id)arg4;
- (void)_notifyRetweet:(id)arg1 originalStatus:(id)arg2 changePending:(_Bool)arg3;
- (void)_asyncNotifyRetweet:(id)arg1 originalStatus:(id)arg2 changePending:(_Bool)arg3;
- (void)_notifyWithFavorite:(_Bool)arg1 originalStatus:(id)arg2 changePending:(_Bool)arg3;
- (void)_asyncNotifyWithFavorite:(_Bool)arg1 originalStatus:(id)arg2 changePending:(_Bool)arg3;
...
- (void)subscribeHTLRealTimeStreamingWithResponseBlock:(CDUnknownBlockType)arg1;
...
- (_Bool)isGlobalSearchTooltipEnabled;
- (_Bool)isGlobalSearchButtonItemEnabledOnExplore;
- (_Bool)isGlobalSearchButtonItemEnabledOnHTL;
- (id)guideTabIcon;
...
- (_Bool)composerPulldownThreadingEnabled;
...
- (_Bool)isPhotoReorderingEnabled;
...
- (_Bool)isTwitterTextEagerRegexCompilationEnabled;
- (_Bool)isTimerStaticSymbolUseEnabled;
- (_Bool)isStatusViewTextSizeCachingEnabled;
- (_Bool)isParallelColorPaletteInitializationEnabled;
- (_Bool)isNetworkingHeadersCasingOptimizationEnabled;
- (_Bool)isNetworkingHeadersAppStateOptimizationEnabled;
- (_Bool)isHomeTimelineTopCursorPrefetchEnabled;
- (_Bool)isHomeTimelinePhase2LegacyDeserializationSkipEnabled;
- (_Bool)isHomeTimelineImpressionCacheAsyncLoadEnabled;
- (_Bool)isHomeTimelineEarlyStartupEnabled;
- (_Bool)isHashflagsBinaryPlistEnabled;
- (_Bool)isGuideEventSummaryImpressionLimitingEnabled;
- (_Bool)isGuideAutolayoutHeightCachingEnabled;
- (_Bool)isDictionaryKeypathOptimizationEnabled;
- (_Bool)isDashSectionsCachingEnabled;
- (_Bool)isDashLazyViewInitializationEnabled;
- (_Bool)isCardLazyViewsEnabled;
- (_Bool)isCardAssociatedPlayerOptimizationsEnabled;
- (_Bool)isActiveRangeEmailRegexOptimizationEnabled;
- (double)framerateMonitorNominalThreadPriority;
- (_Bool)areGeneralCardsOptimizationsEnabled;
...
- (_Bool)isPasswordCheckSettingsUpdatePhoneFlowEnabled;
- (_Bool)isPasswordCheckSettingsUpdateEmailFlowEnabled;
...
- (_Bool)isAuthorModeratedReplyConsumerEnabled;
- (_Bool)isAuthorModeratedReplyAuthorEnabled;
- (_Bool)isTOTPGeneratorEnabled;
- (_Bool)isMuteConversationEnabled;
- (_Bool)is2faNoPhoneEnabled;
...
- (_Bool)isHomeSegmentedViewControllerEnabled;
...
- (id)realTimeStreamingRefreshCountThresholdNumber;
- (id)realTimeStreamingMinimumRefreshIntervalNumber;
- (_Bool)isRealTimeStreamingLivePipelineEnabled;
- (_Bool)isRealTimeStreamingDynamicPollingEnabled;
- (_Bool)isRealTimeStreamingPollingEnabled;
- (id)realTimeStreamingMode;
- (_Bool)isRealTimeStreamingEnabled;
- (id)realTimeStreamingLivePipelineRenewBackoffIntervalNumber;
...
- (_Bool)isDMInboxSearchEnabled;
- (id)reactionsConfiguration;
- (id)_fetchFreshConfiguration;
- (_Bool)isReactionCreationEnabled;
- (_Bool)isQualityFilterTombstoneEnabled;
- (_Bool)isQualityFilterTombstoneEligible;
...
- (_Bool)isContributor;
@property(readonly, nonatomic) _Bool isPreferredPeakBitrateEstimationForVariantSwitchEnabled;
...
@property(readonly, nonatomic, getter=isPackedSegmentedUploadNocopySubrangeDataEnabled) _Bool packedSegmentedUploadNocopySubrangeDataEnabled;
...
- (_Bool)isStatusMutableCopyOptimizationEnabled;
- (_Bool)isLiveEventLazyRectParsingEnabled;
...
- (_Bool)livePipelineHTLRealTimeStreamingTypeSearchEnabled;
- (id)livePipelineHTLRealTimeSearchStreamingQuery;
...
@property(readonly, nonatomic) NSSet *videoAdsAuditWhitelistedUsers;
...
- (_Bool)isV4HeartbeatTrackerEnabled;
