...
@class NSArray, NSString, T1MediaAttachmentAttributionView, T1MediaAttachmentView, T1PillView, TFNButton, TFNCustomHitTestView, TFNPaddedButton, TFNTwitterMediaAsset, TIPImagePipeline, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView;
...
@interface T1MediaAttachmentsViewCell : UICollectionViewCell <T1MediaAttachmentViewDelegate>
{
    ...
    NSArray *_fixedCustomAccessiblityActions;
    NSArray *_customAccessiblityActions;
