...
@interface T1DirectMessageComposeViewController : TFNViewController <T1MediaAttachmentsViewControllerDelegate, T1AltTextViewControllerDelegate, TFNModalContainerViewControllerDelegate, T1FiltersViewControllerDelegate, T1PhotoGalleryViewControllerDelegate, T1FoundMediaControllerDelegate, T1VideoTrimmerViewControllerDelegate, T1DirectMessageComposeTextViewDelegate, T1ComposeCardPreviewControllerDelegate>
{
