...
@class NSLayoutConstraint, NSString, T1AddAvatarView, T1OnboardingHeaderView, T1PhotoSelection, T1PickAndFilterPhotoFlowController, T1ProfileAvatarImageView, TFNTwitterAccount;
...
@interface T1AddAvatarViewController : TFNViewController <TFNLayoutMetricsEnvironment, T1PickAndFilterPhotoFlowControllerDelegate, T1TwitterAuthenticated, T1JumpBackToHomeTimelineBehavior>
{
    ...
    NSLayoutConstraint *_avatarHCenter;
...
- (id)initWithAccount:(id)arg1 title:(id)arg2 subtitle:(id)arg3 nextLabel:(id)arg4 skipLabel:(id)arg5 delegate:(id)arg6 centerAvatar:(_Bool)arg7 requireAvatar:(_Bool)arg8 showCurrentAvatar:(_Bool)arg9 animateAvatar:(_Bool)arg10;
