...
#import <T1Twitter/T1LiveResizingOverlayViewDelegate-Protocol.h>
...
@class NSString, T1AppSplitHostView, T1AppSplitNewsCameraViewController, T1AppSplitSideBarViewController, T1DashViewController, T1LiveResizingOverlayView, T1TabBarViewController, TFNModalSheetViewController, TFNTwitterAccount, TPXSpringAnimator, UIPanGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIScrollView, UITapGestureRecognizer;
@protocol T1AppSplitViewControllerDelegate;

@interface T1AppSplitViewController : UIViewController <UIGestureRecognizerDelegate, TFNLayoutMetricsEnvironment, TPXAnimationObserver, T1AppSplitSideBarViewControllerDelegate, T1DashViewControllerDelegate, T1LiveResizingOverlayViewDelegate, T1DashPresenter, T1AppSplitNewsCameraPresenter>
{
    ...
    T1LiveResizingOverlayView *_liveResizingOverlayView;
    ...
    _Bool _supportsExtendedContent;
    _Bool _visible;
    _Bool _tracking;
    _Bool _dragging;
    _Bool _decelerating;
...
@property(nonatomic) _Bool supportsExtendedContent; // @synthesize supportsExtendedContent=_supportsExtendedContent;
...
- (void)private_hideExtendedContentViewController;
- (void)private_showExtendedContentViewController;
- (void)private_updateForSplitModeSideBar;
- (void)private_updateForSplitModeNone;
- (void)private_updateForSplitMode;
...
- (void)private_notifyForSplitModeAfterClosingDash:(_Bool)arg1;
