...
@interface TFNTwitterTimeline : NSObject
{
    ...
    _Bool _legacyPlistStateSupported;
...
+ (id)_sharedQueue;
@property(nonatomic) _Bool legacyPlistStateSupported; // @synthesize legacyPlistStateSupported=_legacyPlistStateSupported;
...
- (id)initWithAccount:(id)arg1 plistDictionary:(id)arg2 archiveFileFullPath:(id)arg3 legacyPlistStateSupported:(_Bool)arg4;
- (id)initWithAccount:(id)arg1 plistDictionary:(id)arg2 legacyPlistStateSupported:(_Bool)arg3;
