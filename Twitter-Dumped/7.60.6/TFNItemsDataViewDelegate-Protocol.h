...
@class NSDictionary, NSIndexPath, TFNCollectionViewCell, TFNDataViewCellLayout, TFNItemsDataViewAdapter, TFNItemsDataViewController, TFNLayoutMetrics, TFNPreviewConfiguration, TFNTableViewCell, UIDragItem;
@protocol NSCopying;
...
- (void)commitPreviewConfiguration:(TFNPreviewConfiguration *)arg1 forItem:(id)arg2 atIndexPath:(NSIndexPath *)arg3 inDataViewController:(TFNItemsDataViewController *)arg4 withPreviousDataViewAdapter:(TFNItemsDataViewAdapter *)arg5 options:(NSDictionary *)arg6;
