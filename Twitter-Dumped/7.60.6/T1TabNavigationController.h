...
@interface T1TabNavigationController : TFNNavigationController <T1SearchTextViewDelegate, TFNTooltipDelegate, UIDropInteractionDelegate, T1TweetDraftsViewControllerDelegate, T1PanelRootViewController, TFNNavigationControllerTransitionProvider>
{
