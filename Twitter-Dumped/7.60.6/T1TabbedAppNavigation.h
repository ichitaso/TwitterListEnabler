...
- (void)showRuxWithCxt:(id)arg1 refsrcTweet:(id)arg2 statusID:(long long)arg3 panel:(long long)arg4 source:(long long)arg5 completion:(CDUnknownBlockType)arg6;
...
- (id)_t1_conversationContainerViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 account:(id)arg3 statusNavigationContext:(id)arg4 scribeContext:(id)arg5;
- (id)_t1_tweetDetailsViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 account:(id)arg3 statusNavigationContext:(id)arg4 scribeContext:(id)arg5;
- (id)conversationViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 account:(id)arg3 statusNavigationContext:(id)arg4 scribeContext:(id)arg5;
- (void)showConversationViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 account:(id)arg3 statusNavigationContext:(id)arg4 scribeContext:(id)arg5 fromViewController:(id)arg6 animated:(_Bool)arg7;
- (void)showConversationViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 fromPanel:(long long)arg3 source:(long long)arg4 navigationContext:(id)arg5 statusNavigationContext:(id)arg6 completion:(CDUnknownBlockType)arg7;
- (void)_t1_showConversationViewControllerForViewModel:(id)arg1 statusID:(long long)arg2 fromPanel:(long long)arg3 source:(long long)arg4 navigationContext:(id)arg5 statusNavigationContext:(id)arg6 completion:(CDUnknownBlockType)arg7;
...
- (void)showProfileForCurrentAccountFromSource:(long long)arg1 completion:(CDUnknownBlockType)arg2;
