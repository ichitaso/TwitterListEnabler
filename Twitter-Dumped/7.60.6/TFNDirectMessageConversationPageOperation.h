...
@class NSOperation, NSOperationQueue, TFNDirectMessageConversation, TFNDirectMessageFetchConversationPageOperation, TFNDirectMessageModel, TFNDirectMessageProcessConversationPageResponseOperation;

@interface TFNDirectMessageConversationPageOperation : TFSConcurrentOperation <TFNDirectMessageFetchConversationPageOperationDelegate>
{
