...
@class NSArray, NSLayoutConstraint, NSString, T1AutocompleteViewController, T1ComposeAccountAvatarImageView, T1NewsCameraCaptureChyronView, T1NewsCameraCaptureOutput, T1NewsCameraCapturePreviewOverlayView, T1NewsCameraCapturePreviewView, T1NewsCameraColorPicker, T1NewsCameraComposition, T1NewsCameraControlButton, T1NewsCameraEventHashtagsViewController, T1NewsCameraFetchResult, T1NewsCameraGeoPickerButton, T1NewsCameraGeoPickerController, T1NewsCameraTweetTextEditView, T1ThreadTweetsViewController, TFNCircularCountProgressView, TFNKeyboardDismissalContainerView, TFNModalHitTestView, TFNTwitterAccount, TFSTwitterScribeContext, UIButton, UILayoutGuide, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
...
@interface T1NewsCameraCaptureCameraModeEditViewController : TFNViewController <T1AltTextViewControllerDelegate, T1AutocompleteViewControllerDelegate, T1NewsCameraColorPickerDelegate, T1NewsCameraEventHashtagsViewControllerDelegate, T1NewsCameraGeoPickerControllerDelegate, T1NewsCameraTweetTextEditViewDelegate, T1ThreadTweetsViewControllerDelegate, TFNCircularCountProgressDataSource, TFNKeyboardDismissalContainerViewDelegate, TFNModalHitTestViewDelegate, TFNTooltipDelegate, UIGestureRecognizerDelegate, UITextViewDelegate>
{
    ...
    T1NewsCameraCapturePreviewOverlayView *_previewOverlayView;
    UITapGestureRecognizer *_previewOverlayViewTapGestureRecognizer;
...
@property(retain, nonatomic) UITapGestureRecognizer *previewOverlayViewTapGestureRecognizer; // @synthesize previewOverlayViewTapGestureRecognizer=_previewOverlayViewTapGestureRecognizer;
@property(retain, nonatomic) T1NewsCameraCapturePreviewOverlayView *previewOverlayView; // @synthesize previewOverlayView=_previewOverlayView;
...
- (void)_t1_gesture_previewOverlayViewDidTap:(id)arg1;
...
- (void)_t1_main_updatePreviewOverlayView;
- (void)_t1_main_loadPreviewOverlayViewWithConstraints:(id)arg1;
...
- (void)setPreviewContainerViewPositionPercentage:(double)arg1 animated:(_Bool)arg2 withVelocity:(double)arg3 completion:(CDUnknownBlockType)arg4;
