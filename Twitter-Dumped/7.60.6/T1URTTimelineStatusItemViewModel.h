...
@class NSArray, NSDate, NSDictionary, NSString, TFNTwitterCardData, TFNTwitterFeedbackInfo, TFNTwitterFeedbackModule, TFNTwitterGeotag, TFNTwitterMediaInfo, TFNTwitterPromotedContent, TFNTwitterStatusConversationContext, TFNTwitterSuggestsInfo, TFNTwitterUser, TFSTwitterCameraMoment, TFSTwitterEntitySet, TFSTwitterVideoMonetizationSettings, TFSURTRichText, UIColor;
