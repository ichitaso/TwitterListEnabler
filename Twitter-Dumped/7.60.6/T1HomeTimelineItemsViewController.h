...
#import <T1Twitter/T1ContentStreamingSubscriptionManagerDelegate-Protocol.h>
...
@interface T1HomeTimelineItemsViewController : TFNItemsDataViewController <TFNMarkAsViewedDelegate, TFNFrameRateMonitorObserver, UIActionSheetDelegate, UIDataSourceModelAssociation, T1ErrorDataViewAdapterDelegate, T1TimelineMessageEntryTableRowAdapterDelegate, T1LoadingGapDataViewAdapterDelegate, T1LiveBannerTableRowAdapterDelegate, T1URTTimelineTombstoneItemViewModelDelegate, TFNTimelineDismissedItemDelegate, T1UpdateIndicatorDelegate, TFNTooltipDelegate, T1FeedbackActionProvider, T1RelevancePromptTableRowAdapterDelegate, T1ContentStreamingSubscriptionManagerDelegate, T1PanelRootViewController>
{
    ...
    T1ContentStreamingSubscriptionManager *_contentStreamingSubscriptionManager;
    ...
    T1TwitterTooltip *_searchTooltip;
...
@property(retain, nonatomic) T1TwitterTooltip *searchTooltip; // @synthesize searchTooltip=_searchTooltip;
...
@property(readonly, nonatomic) T1ContentStreamingSubscriptionManager *contentStreamingSubscriptionManager; // @synthesize contentStreamingSubscriptionManager=_contentStreamingSubscriptionManager;
...
- (_Bool)contentStreamingSubscriptionManagerShouldEnableStreaming:(id)arg1;
- (id)contentStreamingSubscriptionManagerSubscriptionEntryIdentifier:(id)arg1;
...
- (void)_t1_updateRightBarButtonItems;
