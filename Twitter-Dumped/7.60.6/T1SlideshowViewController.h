...
@property(readonly, nonatomic) double preferredAspectRatio; // @synthesize preferredAspectRatio=_preferredAspectRatio;
...
@property(nonatomic, getter=shouldDisplayCloseButton) _Bool displayCloseButton; // @synthesize displayCloseButton=_displayCloseButton;
