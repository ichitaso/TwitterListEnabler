...
@property(readonly, nonatomic) _Bool includeQuality; // @synthesize includeQuality=_includeQuality;
...
- (id)initWithInbox:(id)arg1 userCache:(id)arg2 source:(long long)arg3 activeConversationID:(id)arg4 filterLowQuality:(id)arg5 includeQuality:(_Bool)arg6;
- (id)init;
