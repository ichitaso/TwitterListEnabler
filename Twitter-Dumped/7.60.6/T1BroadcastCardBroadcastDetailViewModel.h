...
- (id)initWithDisplayName:(id)arg1 displayUsername:(id)arg2 verified:(_Bool)arg3 title:(id)arg4 adString:(id)arg5;
- (id)initWithAttributedUser:(id)arg1 title:(id)arg2 adString:(id)arg3;
