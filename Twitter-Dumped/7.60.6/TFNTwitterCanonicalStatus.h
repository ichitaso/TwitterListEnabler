...
- (_Bool)_tfn_assimilateWithheldText:(id)arg1;
- (_Bool)_tfn_assimilateRetweetCount:(long long)arg1 retweetedByLoadingAccount:(_Bool)arg2 retweetID:(id)arg3;
- (_Bool)_tfn_assimilateFavoriteCount:(long long)arg1 favoritedByLoadingAccount:(_Bool)arg2;
...
- (_Bool)_tfn_assimilateWithheldEntities:(id)arg1;
...
- (_Bool)_tfn_assimilateCardData:(id)arg1 cardJSONData:(id)arg2 cardUsers:(id)arg3 cardDataURL:(id)arg4;
...
- (void)updateRetweetedByLoadingAccount:(_Bool)arg1 retweetChangePending:(_Bool)arg2 retweetID:(id)arg3;
