...
@interface TFNTwitterHomeFeatureSwitchParametersConfig : NSObject <TFNTwitterHomeFeatureSwitchParameters>
{
    ...
    _Bool _timelineLegacyStateSerializationSkipAllowed;
...
@property(nonatomic, getter=isTimelineLegacyStateSerializationSkipAllowed) _Bool timelineLegacyStateSerializationSkipAllowed; // @synthesize timelineLegacyStateSerializationSkipAllowed=_timelineLegacyStateSerializationSkipAllowed;
