...
@class NSSet, NSString, TFNTwitterTypeaheadResults;

@interface T1SearchTypeaheadViewControllerResults : NSObject
{
    NSSet *_prefetchUserSet;
    NSString *_typeaheadString;
    TFNTwitterTypeaheadResults *_prefetch;
    TFNTwitterTypeaheadResults *_remote;
}

@property(readonly, nonatomic) TFNTwitterTypeaheadResults *remote; // @synthesize remote=_remote;
@property(readonly, nonatomic) TFNTwitterTypeaheadResults *prefetch; // @synthesize prefetch=_prefetch;
