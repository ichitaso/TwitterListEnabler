...
@class NSArray, NSString, T1OnboardingChoiceSelectionViewController, TFNOnboardingRichText;

@protocol T1OnboardingChoiceSelectionViewControllerDelegate <NSObject>
- (NSString *)choiceSelectionViewController:(T1OnboardingChoiceSelectionViewController *)arg1 expandedRichText:(TFNOnboardingRichText *)arg2;
