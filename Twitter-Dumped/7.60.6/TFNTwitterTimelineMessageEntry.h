...
@class NSArray, NSDictionary, NSString, TFNTwitterFeedbackInfo, TFNTwitterFeedbackModule, TFNTwitterSuggestsInfo, TFNTwitterTimelineMessageEntryPrompt, TFSURTRichText;
...
@property(readonly, nonatomic) TFSURTRichText *bodyRichText;
@property(readonly, nonatomic) TFSURTRichText *headerRichText;
@property(readonly, nonatomic) long long bodyAlignment;
@property(readonly, nonatomic) long long headerAlignment;
@property(readonly, nonatomic) NSArray *imageVariants;
@property(readonly, nonatomic) _Bool shouldUseNoTopContentPadding;
@property(readonly, nonatomic) _Bool shouldUseStandardSideContentPadding;
