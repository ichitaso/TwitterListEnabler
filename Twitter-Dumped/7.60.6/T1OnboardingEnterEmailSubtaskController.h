...
@class NSString, TFNOnboardingEnterEmailSubtask, TFNOnboardingEnterEmailSubtaskState;
...
{
    TFNOnboardingEnterEmailSubtask *_subtask;
    TFNOnboardingEnterEmailSubtaskState *_state;
