...
@interface T1DashAccountSwitcherView : UIView
{
    ...
    _Bool _firstAvatarNeedsIconAndMessageBadgeLayout;
    _Bool _badgeCollapseAnimationWasRun;
...
@property(nonatomic) _Bool badgeCollapseAnimationWasRun; // @synthesize badgeCollapseAnimationWasRun=_badgeCollapseAnimationWasRun;
@property(nonatomic) _Bool firstAvatarNeedsIconAndMessageBadgeLayout; // @synthesize firstAvatarNeedsIconAndMessageBadgeLayout=_firstAvatarNeedsIconAndMessageBadgeLayout;
...
- (void)_t1_animateClose;
- (void)collapseBadgeIfNeeded;
- (void)expandBadgeIfNeeded;
- (void)updateAccounts;
