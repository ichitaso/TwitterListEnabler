...
@class NSString, T1AvatarImageView, T1ConversationConnectorView, T1DismissButton, T1InfoTextView, T1InlineMediaView, T1StatusAuthorView, T1StatusBodyTextView, T1StatusInlineActionsView, T1StatusLiveEngagementManager, T1StatusNewsCameraAttachmentOverlayView, T1StatusPollIndicatorView, T1StatusReplyBadgeView, T1StatusSensitiveContentView, T1StatusViewAccessibility, T1StatusViewAttachmentContainerView, T1StatusViewScribableItem, T1StatusWithheldInCountryView, T1TagSetView, T1TimelinesItemSocialContextView, T1TimelinesStatusConversationContextView, T1TweetstormIndicatorView, TFNReusableViewCache, TFNSolidColorView, TFNTwitterAccount, TFSTimer, TFSTwitterScribeContext, UIImage, UIView;
...
@interface T1StatusView : TFNLayoutableView <T1StatusAuthorViewDelegate, T1StatusBodyTextViewDelegate, T1StatusInlineActionsViewDelegate, T1StatusViewAttachmentContainerViewDelegate, T1TagSetViewDelegate, T1TimelinesCarouselCollectionViewLayoutMetricsProvider, T1StatusEmbeddedCarouselHost, TFNLayoutGuidesSource, T1AutoplayViewContainer, T1CardViewDelegate, T1TimelinesItemSocialContextViewDelegate, T1TimelinesStatusConversationContextViewDelegate, T1TweetstormIndicatorViewDelegate, T1StatusWithheldInCountryViewDelegate, T1UnifiedCardComponentViewEventDelegate, T1TimelineStatusView>
{
    ...
    T1StatusPollIndicatorView *_pollIndicatorView;
...
@property(retain, nonatomic) T1StatusPollIndicatorView *pollIndicatorView; // @synthesize pollIndicatorView=_pollIndicatorView;
