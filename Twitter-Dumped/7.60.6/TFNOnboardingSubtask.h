...
@interface TFNOnboardingSubtask : NSObject
{
    ...
    TFNOnboardingNavigationLink *_backNavigationLink;
    NSString *_typeName;
}
...
@property(readonly, nonatomic) TFNOnboardingNavigationLink *backNavigationLink; // @synthesize backNavigationLink=_backNavigationLink;
