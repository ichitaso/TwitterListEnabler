...
@class T1OnboardingPromptDataSource, TFNOnboardingPermissionPromptSubtask;
...
@interface T1OnboardingPermissionPromptSubtaskController : T1OnboardingSubtaskController
{
    ...
    TFNOnboardingPermissionPromptSubtask *_subtask;
...
- (id)initWithSubtask:(id)arg1 delegate:(id)arg2 serviceType:(long long)arg3;
