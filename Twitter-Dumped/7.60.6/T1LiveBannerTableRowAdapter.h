...
{
    _Bool _liveEventHappeningNowTilesNewStylingEnabled;
...
@property(nonatomic, getter=isLiveEventHappeningNowTilesNewStylingEnabled) _Bool liveEventHappeningNowTilesNewStylingEnabled; // @synthesize liveEventHappeningNowTilesNewStylingEnabled=_liveEventHappeningNowTilesNewStylingEnabled;
