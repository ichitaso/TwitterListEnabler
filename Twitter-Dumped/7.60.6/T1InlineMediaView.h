...
@class NSString, T1DeadVideoErrorView, T1PrerollCTAModel, T1VideoAdButton, T1VideoBitRateManager, T1VideoCaptionsView, T1VideoSkipCountdownLabel, TAVPlaybackState, TAVPlayerView, TAVScribeContext, TAVUIVideoButtonOverlay, TFNButton, TFNSolidColorView, TFNTwitterAccount, TFNTwitterDynamicVideoAdViewModel, TFSKVODispatcher, TFSTimer, TIPImageContainer, UIActivityIndicatorView, UIButton, UIColor, UIImage, UIImageView, UILongPressGestureRecognizer, UITapGestureRecognizer;
