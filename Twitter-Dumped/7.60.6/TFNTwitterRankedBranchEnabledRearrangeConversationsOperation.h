...
#import <T1Twitter/TFNTwitterTimelineStreamOperation-Protocol.h>

@interface TFNTwitterRankedBranchEnabledRearrangeConversationsOperation : NSObject <TFNTwitterTimelineStreamOperation>
{
}
...
- (id)filteredStreamObjectsFromStreamObjects:(id)arg1;
