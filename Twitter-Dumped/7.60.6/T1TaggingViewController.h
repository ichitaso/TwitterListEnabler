...
@class NSArray, NSMutableArray, NSString, T1AutocompleteResultsController, T1TaggingTableHeaderView, T1TaggingTableView, TFNTwitterAccount, TFSTimer, UIBarButtonItem;
@protocol T1TaggingViewControllerDelegate;

@interface T1TaggingViewController : TFNViewController <TFNTokenFieldDelegate, UIScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, TFNModalSheetViewControllerDelegate, TFNModalSheetViewControllerLayoutDelegate>
{
