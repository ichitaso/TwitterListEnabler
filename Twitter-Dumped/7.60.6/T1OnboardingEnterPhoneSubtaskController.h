...
@class NSString, TFNOnboardingEnterPhoneSubtask, TFNOnboardingEnterPhoneSubtaskState;
...
{
    TFNOnboardingEnterPhoneSubtask *_subtask;
    TFNOnboardingEnterPhoneSubtaskState *_state;
