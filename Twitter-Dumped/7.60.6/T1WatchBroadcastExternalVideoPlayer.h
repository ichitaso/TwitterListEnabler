...
@class NSDate, NSString, NSURL, T1VideoBitRateManager, TAVAudioSessionModeToken, TAVPlaybackState, TAVPlayer, TAVScribeContext, TFNTwitterAccount, TFNTwitterLiveEvent, TFSTwitterBroadcast;
