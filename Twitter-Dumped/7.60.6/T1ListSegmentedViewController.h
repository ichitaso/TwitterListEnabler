...
@protocol T1ListSegmentedViewControllerDelegate;
...
@interface T1ListSegmentedViewController : TFNViewController <T1EditListDetailsViewControllerDelegate, T1ScrollingSegmentedViewControllerDataSource>
{
    ...
    id <T1ListSegmentedViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <T1ListSegmentedViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)scribePage;
- (id)scribe;
