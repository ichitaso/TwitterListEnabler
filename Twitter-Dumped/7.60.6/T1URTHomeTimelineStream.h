...
@protocol T1URTFeedbackPresenter, T1URTItemVisibilityMonitor, TFNTwitterSuggestsModuleWhoToFollowBlender, TFNTwitterTimelineReactiveArticleBlender;
...
@property(nonatomic, readonly) id <T1URTFeedbackPresenter> feedbackPresenter; // @synthesize feedbackPresenter;
