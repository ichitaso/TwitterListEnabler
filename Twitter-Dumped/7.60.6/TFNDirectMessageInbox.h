...
- (void)markAsSeen;
- (void)loadMoreConversationsWithCursor:(id)arg1 includeQuality:(_Bool)arg2;
- (void)refresh:(long long)arg1 activeConversationID:(id)arg2 filterLowQuality:(id)arg3 includeQuality:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
