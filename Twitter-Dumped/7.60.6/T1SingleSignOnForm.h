...
@class NSString, T1SingleSignOnConnectHeader, TFNActivityIndicatorItem, TFNTwitterAccount, TFNTwitterOAuthRequestTokenResponse, TFSTwitterAuthSingleSignOn;
...
@interface T1SingleSignOnForm : T1AuthenticationForm
{
    ...
    TFNTwitterOAuthRequestTokenResponse *_requestToken;
...
@property(retain, nonatomic) TFNTwitterOAuthRequestTokenResponse *requestToken; // @synthesize requestToken=_requestToken;
